...
<table border="1" cellpadding="0" cellspacing="0" width="700">
	<tr>
		...
		<td align="left">
			...
			value="${sample.id}" disabled="disabled">
		</td>
	</tr>
	<tr>
		...
		<td align="left">
			...
			value="${sample.title}" size="52"/>
		</td>
	</tr>
	<tr>
		<td bgcolor="orange">작성자</td>
		<td align="left">
			<input name="regUser" type="text" 
			value="${sample.regUser}"/>
		</td>
	</tr>
	<tr>
		<td bgcolor="orange">내용</td>
		<td align="left">
			<textarea name="content" type="text" cols="40" rows="5">
				${sample.content}
			</textarea> 
		</td>
	</tr>
